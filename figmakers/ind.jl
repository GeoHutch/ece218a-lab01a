...
data_leaded = read_one_port("text_data/passive_inductor.txt")
...
fig = SmithAxis([
                 PGFPlots.SmithData(Z.(S11_interp_leaded[5:end-5]), style="blue", mark="none", legendentry="15pH hand-made inductor"),
...
save("figures/build/smith_ind.pdf",fig)
